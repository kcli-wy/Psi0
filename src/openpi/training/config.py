...
import openpi.policies.psi_policy as psi_policy
...
class LeRobotHFMDataConfig(DataConfigFactory):
    ...
    #     object.__setattr__(self, "base_config", DataConfig(action_sequence_keys=("action",)))
        ...
        repack_transform = _transforms.Group(
            inputs=[
                _transforms.RepackTransform({
                    ...
                    # "observation/leg_joints": "observation.leg_joints",
                    # "observation/torso_rpy": "observation.prev_rpy",
                    # "observation/base_height": "observation.prev_height",
...
_CONFIGS = [
    ...
    ### Experiments on real tasks of Psi0 ###
    TrainConfig(
        name="Hold_lunch_bag_with_both_hands_and_squat_to_put_on_the_coffee_table",
        project_name="psi",
        num_workers=8,
        model=pi0_config.Pi0Config(
            pi05=True,
    ...
    TrainConfig(
        name="Pick_bottle_and_turn_and_pour_into_cup",
        project_name="psi",
        num_workers=8,
        model=pi0_config.Pi0Config(
            pi05=True,
    ...
    TrainConfig(
        name="Pull_the_tray_out_of_chips_can_and_throw_the_can_into_trash_bin",
        project_name="psi",
        num_workers=8,
        model=pi0_config.Pi0Config(
            pi05=True,
    ...
    TrainConfig(
        name="Push_cart_grasp_and_place_grapes_on_plate",
        project_name="psi",
        num_workers=8,
        model=pi0_config.Pi0Config(
            pi05=True,
    ...
    TrainConfig(
        name="Put_dumpling_into_blanket_and_turn_around_and_pass_to_human",
        project_name="psi",
        num_workers=8,
        model=pi0_config.Pi0Config(
            pi05=True,
    ...
    TrainConfig(
        name="Remove_the_cap_turn_on_the_faucet_and_fill_the_bottle_with_water",
        project_name="psi",
        num_workers=8,
        model=pi0_config.Pi0Config(
            pi05=True,
    ...
    TrainConfig(
        name="Rotate_to_pour_ham_into_plate_and_push_the_cart_forward",
        project_name="psi",
        num_workers=8,
        model=pi0_config.Pi0Config(
            pi05=True,
    ...
    TrainConfig(
        name="Spray_the_bowl_and_wipe_it_and_stack_it_up",
        project_name="psi",
        num_workers=8,
        model=pi0_config.Pi0Config(
            pi05=True,
